...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "tabs.mine": "我的",
    "schedule.title": "安排",
    "schedule.subtitle": "尚未发生、但要落地的事情，先放在这里，减轻心智负担。",
    "schedule.tabActive": "进行中",
    "schedule.tabDone": "已完成",
    "schedule.add": "新建安排",
    "schedule.emptyActiveTitle": "还没有安排",
    "schedule.emptyActiveDesc": "可以手动创建一条，后续再接 AI 从对话里识别与合并。",
    "schedule.emptyDoneTitle": "暂无已完成",
    "schedule.emptyDoneDesc": "完成的事项会出现在这里，不占用心智。",
    "schedule.due": "时间",
    "schedule.noDue": "未设定",
    "schedule.complete": "完成",
    "schedule.reopen": "恢复",
    "schedule.composerTitle": "新建安排",
    "schedule.fieldTitle": "内容",
    "schedule.fieldTitlePlaceholder": "写一件你要落地的事…",
    "schedule.fieldTime": "时间（可选）",
    "schedule.save": "保存",
    "schedule.cancel": "取消",
    "search.close": "关闭搜索",
  ...
  "zh-TW": {
    ...
    "tabs.mine": "我的",
    "schedule.title": "安排",
    "schedule.subtitle": "尚未發生、但要落地的事情，先放在這裡，減輕心智負擔。",
    "schedule.tabActive": "進行中",
    "schedule.tabDone": "已完成",
    "schedule.add": "新建安排",
    "schedule.emptyActiveTitle": "還沒有安排",
    "schedule.emptyActiveDesc": "可以手動建立一條，後續再接 AI 從對話裡辨識與合併。",
    "schedule.emptyDoneTitle": "暫無已完成",
    "schedule.emptyDoneDesc": "完成的事項會出現在這裡，不佔用心智。",
    "schedule.due": "時間",
    "schedule.noDue": "未設定",
    "schedule.complete": "完成",
    "schedule.reopen": "恢復",
    "schedule.composerTitle": "新建安排",
    "schedule.fieldTitle": "內容",
    "schedule.fieldTitlePlaceholder": "寫一件你要落地的事…",
    "schedule.fieldTime": "時間（可選）",
    "schedule.save": "儲存",
    "schedule.cancel": "取消",
    "search.close": "關閉搜尋",
  ...
  "en-US": {
    ...
    "schedule.subtitle": "Things not done yet but meant to happen—park them here to ease mental load.",
    "schedule.tabActive": "Open",
    "schedule.tabDone": "Done",
    "schedule.add": "New plan",
    "schedule.emptyActiveTitle": "No plans yet",
    "schedule.emptyActiveDesc": "Create one manually; later AI can pick these up from chats and merge related items.",
    "schedule.emptyDoneTitle": "Nothing completed",
    "schedule.emptyDoneDesc": "Finished items land here so they stay out of mind.",
    "schedule.due": "When",
    "schedule.noDue": "Not set",
    "schedule.complete": "Done",
    "schedule.reopen": "Reopen",
    "schedule.composerTitle": "New plan",
    "schedule.fieldTitle": "What",
    "schedule.fieldTitlePlaceholder": "Describe something you intend to do…",
    "schedule.fieldTime": "Time (optional)",
    "schedule.save": "Save",
  ...
  "ar-SA": {
    ...
    "tabs.mine": "أنا",
    "schedule.title": "خطط",
    "schedule.subtitle": "أشياء لم تحدث بعد لكنها تحتاج متابعة لاحقًا.",
    "schedule.tabActive": "قيد التنفيذ",
    "schedule.tabDone": "مكتمل",
    "schedule.add": "خطة جديدة",
    "schedule.emptyActiveTitle": "لا توجد خطط",
    "schedule.emptyActiveDesc": "أنشئ خطة يدويًا؛ لاحقًا يمكن للذكاء الاصطناعي اقتراحها من المحادثات.",
    "schedule.emptyDoneTitle": "لا شيء مكتمل",
    "schedule.emptyDoneDesc": "العناصر المكتملة تظهر هنا.",
    "schedule.due": "الوقت",
    "schedule.noDue": "غير محدد",
    "schedule.complete": "تم",
    "schedule.reopen": "إعادة فتح",
    "schedule.composerTitle": "خطة جديدة",
    "schedule.fieldTitle": "المحتوى",
    "schedule.fieldTitlePlaceholder": "صف ما تنوي القيام به…",
    "schedule.fieldTime": "الوقت (اختياري)",
    "schedule.save": "حفظ",
